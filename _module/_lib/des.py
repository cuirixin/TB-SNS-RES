...
if __name__ == '__main__':  
    # asdasddjb213hJDHuasddasd!@#456mobile1SDASD
    """
    d = DES('12345678')  
    s = 'test'  
    a = d.encode(s)
    ...
    b = d.decode("cLmTqxkIgXp/HY595eVibHTY1NO8ROZSg2iwxQJOsBEFvmEbcjtk717LwssOgHHs")
    print b
    """
    
    print base64.b64encode("123123")
    print base64.b64encode("你好")
    print base64.b64decode(base64.b64encode(",./&8d"))
    print base64.b16decode(base64.b16encode("123123"))
